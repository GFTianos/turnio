...
module.exports = function(controller) {
    ...
    controller.hears(['trump', 'Trump'], 'ambient', function(bot, message) {
        
        bot.reply(message, ':flag-us: TRUMP FOR PRESIDENT, HE MAKES AMERICA GREAT AGAIN :flag-us:');
    });
    ...
    controller.hears(['identificate'], 'ambient,mention,direct_message,direct_mention', function(bot, message) {
